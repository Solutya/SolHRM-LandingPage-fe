        ...
        {price_data
          ...
          .map((item, i) => (
            ...
            >
              <div
                className={` ${item.cls} ${
                  activeCard === item.id ? "active-card rounded-3xl" : ""} bg-white rounded-3xl px-[30px] py-[25px] md:px-[60px] md:py-[50px] lg:px-[35px] lg:w-[320px] lg:py-[28px] space-y-4  flex flex-col justify-between 2xl:w-[280px] 2xl:h-full  transition duration-500 2xl:gap-0  hover:scale-105 h-full`}
              >
                <div className="w-fit ">
                  <Image
                    src={item?.img}
