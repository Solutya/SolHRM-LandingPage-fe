...
const ScrollToTop = () => {
  ...
  return (
        ...
        <button
          ...
          className={`fixed bottom-4 right-4 flex items-center justify-center p-2 bg-myBlue text-white rounded-full hover:bg-puple-800 focus:outline-none transition-all duration-500 w-fit  border ${showButton ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          onClick={scrollToTop}
